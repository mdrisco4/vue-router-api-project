<template>
    ...
    <div class="intro-information">Some information and a blurb about coin X</div>
    </div>
...
export default {
  ...
  created() {
    axios
      ...
      // ,EUR
      .then((response) => {
        this.cryptos = response.data.RAW.MATIC.USD;
        console.log(response.data);
        console.log(response.data.RAW.MATIC.USD);
